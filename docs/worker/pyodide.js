...
`),console.log("Hybrid Desktop API bridge setup completed successfully")}catch(e){throw console.error("Failed to setup Hybrid Desktop API bridge:",e),e}},async executePython(e,t=!1){if(!this._pyodide)return{success:!1,error:"Pyodide not initialized. Call initPyodide() first."};try{let s="";t&&await this._pyodide.runPython(`
import sys
