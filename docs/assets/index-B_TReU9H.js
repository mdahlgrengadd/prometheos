import{c as We,K as hn,r as N,j as c,X as ut,R as mn,n as pn,s as gn,w as vn,o as kt,l as yn,v as Be,x as bn,G as wn,L as xn,M as jn,f as En,i as kn,N as Tn,O as Cn}from"./index-DqlL-Z1F.js";import{u as Ve,F as Sn,S as _n}from"./fileSystem-DGO8TQIx.js";import{V as Yr,v as Xr}from"./fileSystem-DGO8TQIx.js";import{_ as Je,m as Pn,l as Me}from"./monaco-editor-Dq6WuQlL.js";import{S as $n,a as Rn}from"./square-C9Gi65gm.js";import{P as Nn}from"./play-DqkARMD7.js";import{b as Dn,C as An,m as wt,c as Tt,R as On,d as In,e as Fn,f as Bn}from"./MacroContext-BDjMe1vR.js";import{F as Mn}from"./file-text-FU6StjaO.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vn=We("Bell",[["path",{d:"M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9",key:"1qo2s2"}],["path",{d:"M10.3 21a1.94 1.94 0 0 0 3.4 0",key:"qgo35s"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ln=We("FileCode",[["path",{d:"M10 12.5 8 15l2 2.5",key:"1tg20x"}],["path",{d:"m14 12.5 2 2.5-2 2.5",key:"yinavb"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z",key:"1mlx9k"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Un=We("LayoutGrid",[["rect",{width:"7",height:"7",x:"3",y:"3",rx:"1",key:"1g98yp"}],["rect",{width:"7",height:"7",x:"14",y:"3",rx:"1",key:"6d4xhi"}],["rect",{width:"7",height:"7",x:"14",y:"14",rx:"1",key:"nxv5o0"}],["rect",{width:"7",height:"7",x:"3",y:"14",rx:"1",key:"1bb6yr"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
${j}:${L}:${W}: ERROR: ${Q}${x.text}`}).join(""),$=new Error(`${n}${_}`);return $.errors=i,$.warnings=o,$}function Oe(n,i){for(const o of n)o.detail=i.load(o.detail);return n}function bt(n,i){if(n==null)return null;let o={},k=h(n,o,"file",O),_=h(n,o,"namespace",O),$=h(n,o,"line",de),x=h(n,o,"column",de),F=h(n,o,"length",de),j=h(n,o,"lineText",O),L=h(n,o,"suggestion",O);return ye(n,o,i),{file:k||"",namespace:_||"",line:$||0,column:x||0,length:F||0,lineText:j||"",suggestion:L||""}}function $e(n,i,o,k){let _=[],$=0;for(const x of n){let F={},j=h(x,F,"id",O),L=h(x,F,"pluginName",O),W=h(x,F,"text",O),Q=h(x,F,"location",Ee),se=h(x,F,"notes",me),G=h(x,F,"detail",fe),le=`in element ${$} of "${i}"`;ye(x,F,le);let B=[];if(se)for(const q of se){let te={},J=h(q,te,"text",O),b=h(q,te,"location",Ee);ye(q,te,le),B.push({text:J||"",location:bt(b,le)})}_.push({id:j||"",pluginName:L||k,text:W||"",location:bt(Q,le),notes:B,detail:o?o.store(G):-1}),$++}return _}function et(n,i){const o=[];for(const k of n){if(typeof k!="string")throw new Error(`${ae(i)} must be an array of strings`);o.push(k)}return o}function Yt({path:n,contents:i}){let o=null;return{path:n,contents:i,get text(){const k=this.contents;return(o===null||k!==i)&&(i=k,o=re(k)),o}}}var Xt="0.18.7",Qt=n=>He().build(n),Zt=n=>He().context(n),en=(n,i)=>He().transform(n,i),tn=(n,i)=>He().formatMessages(n,i),nn=(n,i)=>He().analyzeMetafile(n,i),rn=()=>{throw new Error('The "buildSync" API only works in node')},sn=()=>{throw new Error('The "transformSync" API only works in node')},ln=()=>{throw new Error('The "formatMessagesSync" API only works in node')},on=()=>{throw new Error('The "analyzeMetafileSync" API only works in node')},Ie,ot,He=()=>{if(ot)return ot;throw Ie?new Error('You need to wait for the promise returned from "initialize" to be resolved before calling this'):new Error('You need to call "initialize" before calling this')},an=n=>{n=zt(n||{});let i=n.wasmURL,o=n.wasmModule,k=n.worker!==!1;if(!i&&!o)throw new Error('Must provide either the "wasmURL" option or the "wasmModule" option');if(Ie)throw new Error('Cannot call "initialize" more than once');return Ie=cn(i||"",o,k),Ie.catch(()=>{Ie=void 0}),Ie},cn=(n,i,o)=>S(void 0,null,function*(){let k;if(o){let L=new Blob([`onmessage=((postMessage) => {
