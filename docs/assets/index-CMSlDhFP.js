import{c as H,r as a,w as Ce,j as e,n as je,s as K,l as _e,v as L,H as Ee,f as S}from"./index-BnUfJTsF.js";import{J as R,ad as J,ae as Pe,af as Se,ag as Ie,ah as De,ai as Te,aj as Me,ak as Ae,al as Re,am as ze,an as Le,ao as Oe,ap as $e,aq as Fe,ar as Ue,as as He,C as X,at as Be,au as Ge,k as Ke,B as P,a9 as q,av as W,aw as We,b as Ve,ax as V}from"./MacroContext-CI7yDyp4.js";import{B as U}from"./badge-CFYfHbDB.js";import{P as B}from"./play-o_kb57MA.js";import{T as Je,P as Xe,D as qe}from"./trash-2-BHGirraF.js";import{a as Ye,S as Qe}from"./square-BoOhzoBF.js";import{F as Ze}from"./file-text-CY_aM_2A.js";import"./monaco-editor-Dq6WuQlL.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const et=H("BookOpen",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tt=H("EllipsisVertical",[["circle",{cx:"12",cy:"12",r:"1",key:"41hilf"}],["circle",{cx:"12",cy:"5",r:"1",key:"gxeob9"}],["circle",{cx:"12",cy:"19",r:"1",key:"lyex9k"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const nt=H("Type",[["polyline",{points:"4 7 4 4 20 4 20 7",key:"1nosan"}],["line",{x1:"9",x2:"15",y1:"20",y2:"20",key:"swin9y"}],["line",{x1:"12",x2:"12",y1:"4",y2:"20",key:"1tx1rr"}]]),ot=t=>{const n=()=>Date.now().toString()+Math.random().toString(36).substr(2,9),o=()=>t&&t.length>0?t.map(i=>({id:i.id||n(),type:i.type,content:i.content,output:"",executionCount:0})):[{id:n(),type:"code",content:`# Welcome to your Python notebook!
...
Try the API tests in the sidebar to see what's available!`}]}],Ne=({category:t,testCase:n,level:o,selectedTestId:s,onCategoryToggle:r,onTestSelect:m})=>{const f=()=>{t&&r?r(t.id):n&&m&&m(n)};if(t){const u=t.icon;return e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center py-1 px-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 rounded",onClick:f,style:{paddingLeft:`${o*12+8}px`},children:[e.jsx("span",{className:"mr-1",children:t.expanded?e.jsx(Ve,{size:16}):e.jsx(X,{size:16})}),e.jsx(u,{size:16,className:"mr-2 text-blue-500"}),e.jsx("span",{className:"text-sm font-medium",children:t.name})]}),t.expanded&&e.jsx("div",{children:t.cases.map(p=>e.jsx(Ne,{testCase:p,level:o+1,selectedTestId:s,onTestSelect:m},p.id))})]})}if(n){const u=s===n.id;return e.jsxs("div",{className:`flex items-center py-1 px-2 cursor-pointer rounded transition-colors ${u?"bg-blue-100 dark:bg-blue-900/50 text-blue-900 dark:text-blue-100":"hover:bg-gray-100 dark:hover:bg-gray-800"}`,onClick:f,style:{paddingLeft:`${o*12+8}px`},children:[e.jsx(Ze,{size:14,className:`mr-2 ${u?"text-blue-600 dark:text-blue-400":"text-gray-500"}`}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("div",{className:"text-sm truncate",children:n.name}),e.jsx("div",{className:"text-xs text-gray-500 truncate",children:n.description})]})]})}return null},At=()=>{const[t,n]=a.useState(Mt),[o,s]=a.useState(280),[r,m]=a.useState(!1),[f,u]=a.useState(0),[p,y]=a.useState(0),[b,v]=a.useState(!1),[N,x]=a.useState("Not started"),[I,T]=a.useState(null),[M,_]=a.useState([{id:"welcome",type:"markdown",content:`# Welcome to Python Notebook
...
# This will be handled by the notebook's execution system`}]);a.useEffect(()=>{const h=async()=>{try{const k=await R.isPyodideReady();v(k),x(k?"Pyodide ready!":"Pyodide not started")}catch(k){console.error("Error checking Pyodide status:",k),x("Status check failed")}};h();const E=setInterval(h,2e3);return()=>clearInterval(E)},[]);const D=h=>{n(E=>E.map(k=>k.id===h?{...k,expanded:!k.expanded}:k))},$=h=>{T(h.id),_([{id:`test-${h.id}-${Date.now()}`,type:h.type,content:h.code}])};a.useEffect(()=>{const h=k=>{if(!r)return;const i=k.clientX-f,d=Math.max(200,Math.min(500,p+i));s(d)},E=()=>{m(!1),document.body.style.cursor="",document.body.style.userSelect=""};return r&&(document.addEventListener("mousemove",h),document.addEventListener("mouseup",E),document.body.style.cursor="col-resize",document.body.style.userSelect="none"),()=>{document.removeEventListener("mousemove",h),document.removeEventListener("mouseup",E)}},[r,f,p]);const F=h=>{m(!0),u(h.clientX),y(o),h.preventDefault()};return e.jsxs("div",{className:"flex h-full bg-white dark:bg-gray-900 overflow-hidden",children:[e.jsxs("div",{className:"flex-shrink-0 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex flex-col",style:{width:`${o}px`},children:[e.jsxs("div",{className:"p-3 border-b border-gray-200 dark:border-gray-700",children:[e.jsx("h3",{className:"text-sm font-semibold text-gray-900 dark:text-gray-100",children:"Test Cases"}),e.jsxs("div",{className:"mt-2 flex items-center text-xs",children:[e.jsx("div",{className:`w-2 h-2 rounded-full mr-2 ${b?"bg-green-500":"bg-red-500"}`}),e.jsx("span",{className:"text-gray-600 dark:text-gray-400",children:N})]})]}),e.jsx("div",{className:"p-2 overflow-auto flex-1",children:t.map(h=>e.jsx(Ne,{category:h,level:0,selectedTestId:I,onCategoryToggle:D,onTestSelect:$},h.id))})]}),e.jsx("div",{className:"w-1 cursor-col-resize bg-gray-200 dark:bg-gray-700 hover:bg-blue-400 dark:hover:bg-blue-600 transition-colors",onMouseDown:F}),e.jsx("div",{className:"flex-1 overflow-hidden",children:e.jsx(Tt,{className:"h-full",initialCells:M})})]})},Gt={id:V.id,manifest:V,init:async()=>{console.log("Python Notebook plugin initialized")},render:()=>e.jsx(At,{}),onOpen:()=>{console.log("Python Notebook plugin opened")},onClose:()=>{console.log("Python Notebook plugin closed")}};export{Gt as default};
